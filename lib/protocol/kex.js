...
function handleKexInit(self, payload) {
  ...
  */
  ...
  if (i === clientList.length) {
    ...
    return doFatalError(
      self,
      `Handshake failed: ${colors.red('no matching key exchange algorithm')}, server key exchange algorithms: ${colors.red(serverList)}`,
      'handshake',
      DISCONNECT_REASON.KEY_EXCHANGE_FAILED
    );
  }
  ...
  if (i === clientList.length) {
    ...
    return doFatalError(
      self,
      `Handshake failed: ${colors.red('no matching host key format')}, server key formats: ${colors.red(serverList)}`,
      'handshake',
      DISCONNECT_REASON.KEY_EXCHANGE_FAILED
    );
  }
  ...
  if (i === clientList.length) {
    ...
    return doFatalError(
      self,
      `Handshake failed: ${colors.red('no matching C->S cipher')}, server ciphers: ${colors.red(serverList)}`,
      'handshake',
      DISCONNECT_REASON.KEY_EXCHANGE_FAILED
    );
  }
  ...
  if (i === clientList.length) {
    ...
    return doFatalError(
      self,
      `Handshake failed: ${colors.red('no matching S->C cipher')}, server ciphers: ${colors.red(serverList)}`,
      'handshake',
      DISCONNECT_REASON.KEY_EXCHANGE_FAILED
    );
  }
  ...
  if (CIPHER_INFO[init.cs.cipher].authLen > 0) {
    ...
    if (i === clientList.length) {
      ...
      return doFatalError(
        self,
        `Handshake failed: ${colors.red('no matching C->S MAC')}, server MAC: ${colors.red(serverList)}`,
        'handshake',
        DISCONNECT_REASON.KEY_EXCHANGE_FAILED
      );
    }
  ...
  if (CIPHER_INFO[init.sc.cipher].authLen > 0) {
    ...
    if (i === clientList.length) {
      ...
      return doFatalError(
        self,
        `Handshake failed: ${colors.red('no matching S->C MAC')}, server MAC: ${colors.red(serverList)}`,
        'handshake',
        DISCONNECT_REASON.KEY_EXCHANGE_FAILED
      );
    }
